  ...
  componentDidUpdate(prevProps) {
    ...
    if (prevProps !== this.props) {
      ...
      fields.forEach(field => {
        this.setState({
          [field.name]: { value: '', isRequired: field.isRequired },
        });
      });
    }
  }
        ...
        case INPUTS.textField:
          return (
            <TextField
              ...
              onChange={event => {
                this.handleChange(field.name, event.target.value);
              }}
              type="text"
              fullWidth
            />
          );
        case INPUTS.monthPicker:
          return (
            <MonthPicker

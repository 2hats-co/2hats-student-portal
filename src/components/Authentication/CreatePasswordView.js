...
function CreatePasswordView(props) {
    const { firstName, isLoading, onSignupRoute, GTeventHandler, changeHandler, password, passwordAction } = props;
    ...
    <React.Fragment>
        ...
        <Typography variant="subheading" style={{marginTop:15, marginBottom:20}}>OR</Typography>

...
function PasswordView(props) {
    const { isLoading, email, backHandler, changeHandler, firstName, password, passwordAction, forgotPasswordHandler } = props;
    ...
    <React.Fragment>
        ...
        <Grid container alignItems="center" justify="space-between" style={{marginTop:40}}>
            <Button disabled={isLoading} onClick={passwordAction} style={{width:120}}>
                Sign in
            </Button>

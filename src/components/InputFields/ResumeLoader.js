  ...
  render() {
    ...
    return (
      <div style={!theme.responsive.isMobile ? { minWidth: 420 } : {}}>
        ...
        <MessageBar
          message="Please upload your resume file in PDF format"
          isOpen={this.state.errorBar}
          duration={4000}
          variant="error"
          closeHandler={this.handleCloseSnackbar}
        />
      </div>
    );
  }
...
export default withStyles(styles, { withTheme: true })(
  connect(mapStateToProps)(ResumeLoader)
);

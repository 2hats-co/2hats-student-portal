  ...
  })(
    {
        ...
        function(t, e, i) {
          ...
          e.exports = function(t, e, i, r, n) {
            ...
            for (o = 0; o < i; o++) {
              for (
                a = (o + 0.5) * E + n,
                  A = Math.max(0, Math.floor(a - v)),
                  u = (s = Math.min(e - 1, Math.ceil(a + v))) - A + 1,
                ...
                (g += d = _((l + 0.5 - a) * y)), (h[c] = d);
              for (c = I = 0; c < h.length; c++)
                (I += m = h[c] / g), (f[c] = U(m));
              for (f[i >> 1] += U(1 - I), p = 0; p < f.length && 0 === f[p]; )
                p++;
              if (p < f.length) {
                for (w = f.length - 1; 0 < w && 0 === f[w]; ) w--;
                if (
                  ((B = A + p), (b = w - p + 1), (Q[x++] = B), (Q[x++] = b), D)
                )
                  for (c = p; c <= w; c++) Q[x++] = f[c];
                else Q.set(f.subarray(p, w + 1), x), (x += b);
              } else (Q[x++] = 0), (Q[x++] = 0);
            }
            return Q;
          };
      ...
      8: [
        function(t, e, i) {
          ...
          function y(t, e, i) {
            if (A)
              e.set(((r = t), new Uint8Array(r.buffer, 0, r.byteLength)), i);
            else
          ...
          e.exports = function(t) {
            var e = t.src,
              ...
              l = E(f, i, n, a, s),
              c = E(f, r, o, A, u),
              d = this.__align(0 + Math.max(e.byteLength, h.byteLength)),
              I = this.__align(d + r * n * 4),
              m = this.__align(I + l.byteLength),
              p = m + c.byteLength,
          ...
          (r.prototype.acquire = function() {
            ...
            return (
              0 !== this.available.length
                ? (e = this.available.pop())
                : (((e = this.create()).id = this.lastId++),
                  (e.release = function() {
                    return t.release(e);
                  })),
              (this.acquired[e.id] = e)
            );
          }),
        ...
        function(t, e, i) {
          ...
          e.exports = function(t) {
            var e,
              ...
              u = l(t.srcTileSize * A) - 2 * t.destTileBorder,
              h = l(t.srcTileSize * s) - 2 * t.destTileBorder;
            if (u < 1 || h < 1)
              throw new Error(
            ...
            for (n = 0; n < t.toHeight; n += h)
              for (r = 0; r < t.toWidth; r += u)
                (e = r - t.destTileBorder) < 0 && (e = 0),
                  e + (o = r + u + t.destTileBorder - e) >= t.toWidth &&
                    (o = t.toWidth - e),
                  (i = n - t.destTileBorder) < 0 && (i = 0),
                  i + (a = n + h + t.destTileBorder - i) >= t.toHeight &&
                    (a = t.toHeight - i),
                  (f = {
                    toX: e,
                    toY: i,
      ...
      12: [
        function(t, e, i) {
          ...
          (e.exports.isCanvas = function(t) {
            var e = r(t);
            return (
              '[object HTMLCanvasElement]' === e || '[object Canvas]' === e
            );
          }),
        ...
        function(t, e, i) {
          ...
          e.exports = function() {
            ...
            onmessage = function(t) {
              var e = t.data.opts;
              n || (n = new r(t.data.features));
              var i = n.resizeAndUnsharp(e);
      ...
      14: [
        function(t, e, i) {
          ...
          function l(t, e, i, r, n, o) {
            var a, A, s, u, h, f, g, l, c, d, I, m, p, w;
            for (c = 0; c < o; c++) {
              for (
                l = 0,
                  u = h = (a = t[(f = (g = c) * n)]) * r[6],
        ...
        function(t, e, i) {
          ...
          (A.prototype.use = function(t) {
            return (
              ...
              this.has_wasm && this.options.wasm && t.wasm_fn
              ...
              return (
                (this.__init_promise = Promise.all(
                  Object.keys(i.__modules).map(function(e) {
                    var t = i.__modules[e];
                    return i.has_wasm && i.options.wasm && t.wasm_fn
                      ? i.__wasm[e]
                        ? null
                        : WebAssembly.compile(
                  ...
                  Math.abs(m) >= _ &&
                    ...
                    0 === h
                      ...
                      : ((c =
                        ...
                        (d >>= 8),
                        (a =
                          43690 <= (I = (u + 21845) & 65535)
                            ? c
                            : 32767 <= I
                            ? c + ((6 * (d - c) * (43690 - I) + 32768) >> 16)
                            : 10922 <= I
                            ? d
                            : c + ((6 * (d - c) * I + 32768) >> 16)),
                        (A =
          ...
          e.exports = function(t, e, i, r, n, o) {
            if (!(0 === r || n < 0.5)) {
              ...
              var a = e * i,
                ...
                c = l + u,
                d = c + h,
                I = this.__instance('unsharp_mask', A + s + 2 * u + h + 32, {
                  exp: Math.exp,
                }),
                m = new Uint32Array(t.buffer);
              new Uint32Array(this.__memory.buffer).set(m);
              var p = I.exports.hsl_l16 || I.exports._hsl_l16;
              p(0, f, e, i),
                (p = I.exports.blurMono16 || I.exports._blurMono16)(
                  f,
                  g,
                  l,
                  c,
                ...
                (p = I.exports.unsharp || I.exports._unsharp)(
                  0,
                  0,
                  f,
                  g,
        ...
        function(t, e, i) {
          ...
          e.exports = function(t, e) {
            ...
            var g =
              ...
              c = new Blob([g], { type: 'text/javascript' });
            if (e && e.bare) return c;
            var d = l.createObjectURL(c),
              I = new Worker(d);
      ...
      '/': [
        function(o, t, e) {
          ...
          var n = 1;
          'undefined' != typeof navigator &&
            (n = Math.min(navigator.hardwareConcurrency || 1, 4));
          var h = {
              tile: 1024,
              concurrency: n,
              features: ['js', 'wasm', 'ww'],
          ...
          function l(t) {
            ...
            this.options = m({}, h, t || {});
            var e = 'lk_' + this.options.concurrency;
          ...
          (l.prototype.init = function() {
            ...
            if (
              ...
              try {
                o('webworkify')(function() {}).terminate(),
                  (this.features.ww = !0);
                var t = 'wp_' + JSON.stringify(this.options);
                u[t]
                  ? (this.__workersPool = u[t])
                  : ((this.__workersPool = new A(g, this.options.idle)),
            ...
            return (
              (n = _
                ...
                : Promise.resolve(!1)),
              (this.__initPromise = Promise.all([r, n]).then(function() {
                return e;
              })),
              this.__initPromise
            );
          }),
            (l.prototype.resize = function(t, o, e) {
              var g = this;
              ...
              var d = Math.ceil(Math.max(3, (2.5 * a.unsharpRadius) | 0));
              return this.init().then(function() {
                if (l) return c;
                if (g.features.cib) {
                  var n = o.getContext('2d', { alpha: Boolean(a.alpha) });
                  return (
                    g.debug('Resize via createImageBitmap()'),
                    createImageBitmap(t, {
                ...
                var h = {},
                  f = function(o, i, a) {
                    var A = void 0,
                      ...
                      u = void 0,
                      r = function(n) {
                        return g.__limit(function() {
                          if (l) return c;
                          var r = void 0;
                          if (p.isCanvas(o))
                            g.debug('Get tile pixel data'),
                          ...
                          return (
                            g.debug('Invoke resize math'),
                            Promise.resolve()
                              .then(function() {
                                return (
                                  (t = i),
                                  Promise.resolve().then(function() {
                                    return g.features.ww
                                      ? new Promise(function(e, i) {
                                          var r = g.__workersPool.acquire();
                                          c &&
                                            c.catch(function(t) {
                                              return i(t);
                                            }),
                                      ...
                                      : g.__mathlib.resizeAndUnsharp(t, h);
                                  })
                                );
                                var t;
                              })
                              .then(function(t) {
                                ...
                                if (
                                  ...
                                  (e = u.createImageData(n.toWidth, n.toHeight))
                                    .data.set
                                )
                                  e.data.set(t);
                                else
                                  for (var i = e.data.length - 1; 0 <= i; i--)
                                    e.data[i] = t[i];
                                return (
                                  g.debug('Draw tile'),
                                  B
                    ...
                    return Promise.resolve()
                      ...
                      .then(function() {
                        if (l) return c;
                        g.debug('Calculate tiles');
                        var t = w({
                          width: a.width,
                          height: a.height,
                          srcTileSize: g.options.tile,
                          toWidth: a.toWidth,
                          toHeight: a.toHeight,
                          destTileBorder: d,
                        }).map(function(t) {
                        ...
                        return (
                          g.debug('Process tiles'),
                          Promise.all(t).then(
                            function() {
                              return g.debug('Finished!'), e(), i;
                            },
                            function(t) {
                              throw (e(), t);
                            }
                ...
                return (function t(e, i, r, n) {
                  ...
                  return (
                    u ||
                      ...
                      (h.height = s)),
                    f(i, u ? r : h, n).then(function() {
                      return u
                        ? r
                        : ((n.width = A), (n.height = s), t(e, h, r, n));
                    })
                  );
                })(
                  s(
            ...
            (l.prototype.resizeBuffer = function(t) {
              var e = this,
                i = m({}, f, t);
              return this.init().then(function() {
            ...
            (l.prototype.toBlob = function(o, a, A) {
              return (
                (a = a || 'image/png'),

/* pica 4.1.1 nodeca/pica */ (function(f) {
  ...
  })()(
    {
      1: [
        function(require, module, exports) {
          ...
          MathLib.prototype.resizeAndUnsharp = function resizeAndUnsharp(
            options,
            cache
          ) {
      ...
      5: [
        function(require, module, exports) {
          ...
          module.exports = function resize(options) {
            ...
            var quality =
              typeof options.quality === 'undefined' ? 3 : options.quality;
      ...
      6: [
        function(require, module, exports) {
          ...
          module.exports = function resizeFilterGen(
            ...
            var packedFilter = new Int16Array(
              (maxFilterElementSize + 2) * destSize
            );
            ...
            for (destPixel = 0; destPixel < destSize; destPixel++) {
              ...
              for (pxl = srcFirst, idx = 0; pxl <= srcLast; pxl++, idx++) {
                floatVal = filterFunction(
                  (pxl + 0.5 - srcPixel) * scaleClamped
                );
                total += floatVal;
              ...
              leftNotEmpty = 0;
              while (
                leftNotEmpty < fxpFilter.length &&
                fxpFilter[leftNotEmpty] === 0
              ) {
                leftNotEmpty++;
              }
          ...
          module.exports = [
            ...
            },
            {
              ...
              filter: function filter(x) {
                ...
                var xpi = x * Math.PI;
                return (
                  (Math.sin(xpi) / xpi) * (0.54 + 0.46 * Math.cos(xpi / 1.0))
                );
              },
            },
            {
              ...
              filter: function filter(x) {
                ...
                var xpi = x * Math.PI;
                return (
                  ((Math.sin(xpi) / xpi) * Math.sin(xpi / 2.0)) / (xpi / 2.0)
                );
              },
            },
            {
              ...
              filter: function filter(x) {
                ...
                var xpi = x * Math.PI;
                return (
                  ((Math.sin(xpi) / xpi) * Math.sin(xpi / 3.0)) / (xpi / 3.0)
                );
              },
            },
          ];
      ...
      8: [
        function(require, module, exports) {
          ...
          module.exports = function resize_wasm(options) {
            ...
            var tmp_offset = this.__align(
              src_offset + Math.max(src.byteLength, dest.byteLength)
            );
            var filtersX_offset = this.__align(tmp_offset + srcH * destW * 4);
            var filtersY_offset = this.__align(
              filtersX_offset + filtersX.byteLength
            );
            ...
            var fn =
              instance.exports.convolveHV || instance.exports._convolveHV;
      ...
      10: [
        function(require, module, exports) {
          ...
          module.exports = function createStages(
            fromWidth,
            fromHeight,
            toWidth,
            toHeight,
            ...
            var minScale =
              (2 * destTileBorder + MIN_INNER_TILE_SIZE + 1) / srcTileSize;

            // refuse to scale image multiple times by less than twice each time,
            // it could only happen because of invalid options
            if (minScale > 0.5) return [[toWidth, toHeight]];

            var stageCount = Math.ceil(
              Math.log(Math.min(scaleX, scaleY)) / Math.log(minScale)
            );
      ...
      11: [
        function(require, module, exports) {
          ...
          module.exports = function createRegions(options) {
            ...
            var innerTileWidth =
              pixelFloor(options.srcTileSize * scaleX) -
              2 * options.destTileBorder;
            var innerTileHeight =
              pixelFloor(options.srcTileSize * scaleY) -
              2 * options.destTileBorder;
            ...
            for (
              innerY = 0;
              innerY < options.toHeight;
              innerY += innerTileHeight
            ) {
              for (
                innerX = 0;
                innerX < options.toWidth;
                innerX += innerTileWidth
              ) {
                ...
                toTileWidth =
                  innerX + innerTileWidth + options.destTileBorder - x;
                ...
                toTileHeight =
                  innerY + innerTileHeight + options.destTileBorder - y;
      ...
      12: [
        function(require, module, exports) {
          ...
          module.exports.isCanvas = function isCanvas(element) {
            ...
            return (
              cname === '[object HTMLCanvasElement]' /* browser */ ||
      ...
      16: [
        function(require, module, exports) {
          ...
          MultiMath.prototype.init = function() {
            ...
            this.__init_promise = Promise.all(
              Object.keys(self.__modules).map(function(name) {
                ...
                if (!self.has_wasm || !self.options.wasm || !module.wasm_fn)
                  return null;
                ...
                return WebAssembly.compile(
                  self.__base64decode(module.wasm_src)
                ).then(function(m) {
                  self.__wasm[name] = m;
                });
              })
          ...
          //
          MultiMath.prototype.__instance = function instance(
            name,
            memsize,
            env_extra
          ) {
            ...
            if (!this.__wasm[name]) {
              ...
              this.__wasm[name] = new WebAssembly.Module(
                this.__base64decode(module.wasm_src)
              );
            }
      ...
      20: [
        function(require, module, exports) {
          ...
          module.exports = function unsharp(
            img,
            width,
            height,
            amount,
            ...
            for (var i = 0; i < size; i++) {
              ...
              if (Math.abs(diff) >= thresholdFp) {
                ...
                if (min === max) {
                  ...
                  h =
                    r === max
                      ? (((g - b) * 0xffff) / (6 * (max - min))) | 0
                      : g === max
                      ? 0x5555 + ((((b - r) * 0xffff) / (6 * (max - min))) | 0) // 0x5555 == 0xffff / 3
                ...
                if (s === 0) {
                  ...
                  r =
                    hShifted >= 0xaaaa
                      ? m1 // 0xaaaa == 0xffff * 2 / 3
                      : hShifted >= 0x7fff
                      ? m1 +
                        (((m2 - m1) * 6 * (0xaaaa - hShifted) + 0x8000) >> 16)
                      : hShifted >= 0x2aaa
                      ? m2 // 0x2aaa == 0xffff / 6
      ...
      '/': [
        function(require, module, exports) {
          ...
          function Pica(options) {
            ...
            this.__limit =
              singletones[limiter_key] ||
              utils.limiter(this.options.concurrency);
          ...
          Pica.prototype.init = function() {
            ...
            this.__initPromise = Promise.all([initMath, checkCibResize]).then(
              function() {
                return _this;
              }
            );
          ...
          Pica.prototype.resize = function(from, to, options) {
            ...
            var destTileBorder = Math.ceil(
              Math.max(DEST_TILE_BORDER, (2.5 * opts.unsharpRadius) | 0)
            );
            ...
            return this.init().then(function() {
              ...
              var invokeResize = function invokeResize(opts) {
                return Promise.resolve().then(function() {
                  if (!_this2.features.ww)
                    return _this2.__mathlib.resizeAndUnsharp(opts, cache);
                ...
                var processTile = function processTile(tile) {
                  return _this2.__limit(function() {
                    ...
                    if (utils.isCanvas(from)) {
                      ...
                      srcImageData = srcCtx.getImageData(
                        tile.x,
                        tile.y,
                        tile.width,
                        tile.height
                      ...
                      srcImageData = tmpCtx.getImageData(
                        0,
                        0,
                        tile.width,
                        tile.height
                    ...
                    return Promise.resolve()
                      ...
                      .then(function(result) {
                        ...
                        if (CAN_NEW_IMAGE_DATA) {
                          ...
                          toImageData = toCtx.createImageData(
                            tile.toWidth,
                            tile.toHeight
                          );
                          ...
                          if (toImageData.data.set) {
                            ...
                            // IE9 don't have `.set()`
                            for (
                              var i = toImageData.data.length - 1;
                              i >= 0;
                              i--
                            ) {
                ...
                return Promise.resolve()
                  .then(function() {
                    ...
                    if (utils.isImage(from)) {
                      ...
                      return createImageBitmap(from).then(function(
                        imageBitmap
                      ) {
              ...
              var processStages = function processStages(
                stages,
                from,
                to,
                opts
                ...
                return tileAndResize(
                  from,
                  isLastStage ? to : tmpCanvas,
                  opts
                ).then(function() {

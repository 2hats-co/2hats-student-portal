...
const eduEmptyFields = industry => [
  ...
  {
    type: INPUTS.monthPicker,
    name: 'startDate',
    label: 'Start',
    maxRefrence: 'endDateValue',
    isRequired: true,
  },
  {
    type: INPUTS.monthPicker,
    ...
    minRefrence: 'startDateValue',
    isRequired: true,
  },
  {
    type: INPUTS.multiLine,
    name: 'description',
    label: 'description',
    placeholder: getPrompts(industry).edu,
    hint:
      'You should include your average mark and any key achievements related to your study.',
    isRequired: true,
  },
];
const expEmptyFields = industry => [
  ...
  {
    type: INPUTS.dropDown,
    name: 'type',
    label: 'Type of Experience',
    list: ['Extra Curricular', 'Employment', 'Internship', 'Project'],
    isRequired: true,
  },
  {
    type: INPUTS.monthPicker,
  ...
  },
  {
    ...
    name: 'description',
    label: 'description',
    placeholder: getPrompts(industry).exp,
    hint:
      'This description should focus on your key achievements in this position/job.',
    isRequired: true,
  },
];
